...
static ::_pb::Metadata file_level_metadata_query_2eproto[2];
...
const uint32_t TableStruct_query_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::QueryRequest, _impl_.query_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::QueryResponse, _impl_.response_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::QueryRequest)},
  { 7, -1, -1, sizeof(::QueryResponse)},
};
...
const ::_pbi::DescriptorTable descriptor_table_query_2eproto = {
    false, false, 87, descriptor_table_protodef_query_2eproto,
    "query.proto",
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "QueryRequest.query"));
        } else
          goto handle_unusual;
        continue;
      default:
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "QueryResponse.response"));
        } else
          goto handle_unusual;
        continue;
      default:
...
template<> PROTOBUF_NOINLINE ::QueryResponse*
Arena::CreateMaybeMessage< ::QueryResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::QueryResponse >(arena);
}
