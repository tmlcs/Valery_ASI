...
function createContainer(options = {}) {
  ...
  const Container2 = React40.forwardRef(function Container3(inProps, ref) {
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React41.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React41.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React41.useContext(GridOverflowContext);
    const {
      className,
      children: children2,
    ...
    let result = (0, import_jsx_runtime14.jsx)(GridRoot, _extends({
      ...
      children: React41.Children.map(children2, (child) => {
        if (React41.isValidElement(child) && isMuiElement(child, ["Grid"])) {
...
function joinChildren(children2, separator) {
  const childrenArray = React42.Children.toArray(children2).filter(Boolean);
  return childrenArray.reduce((output, child, index) => {
    output.push(child);
    if (index < childrenArray.length - 1) {
      output.push(React42.cloneElement(separator, {
        key: `separator-${index}`
      }));
    }
    return output;
...
function createStack(options = {}) {
  ...
  const Stack2 = React42.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
